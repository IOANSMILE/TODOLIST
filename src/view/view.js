...
class View extends EventEmitter {
    ...
    createElement(todo) {
        ...
        const item = createElement("li", {
            ...
            "data-id": todo.id
        }, checkbox, label, editInput, editButton, removeButton); // ЖОПА тут тоже могут быть ошибки
    ...
    handleAdd(event) {  // метод проверяет есть ли в поле ввода текст
        ...
        } // если такста нет то вылетает сообщение
    ...
    handleRemove({target}) {  // проверить на работоспособность
        const listItem = target.parentNode;
